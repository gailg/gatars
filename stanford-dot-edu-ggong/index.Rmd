...
`gatars_test_size` calculates the P-values of the following seven statistics: the three
...
produce the smallest P-value within specified constraints.  Instead, `gatars_test_size` estimates the
