...
#' 
#' @param hotspot The \pkg{gritsr3} package provides this data set for your 
...
#' 
#' @template gritsr_sampling_set_examples
#' @export
gritsr_sampling_set = function(
  bim,
  genotype,
  target_markers,
  exclusion_region,
  ...
  class(answer) = c("gritsr_sampling_set", class(answer))
  answer
}
