...
## `fam` has `r nrow(fam)` rows and includes the columns `y` and `ey`
...
Recall our notation:  $G$ is the $N \times M$ genotype matrix of target markers,  $y$ is the $N$-vector indicator for disease or a quantative measurement, and  ${ey}$ is an $N$-vector of trait predictions.
